-- --------------------------------------------------------------------
-- TEST CASE: Successful call of procedure calculate rating metrics

-- DESCRIPTION: Content, clients and reviews made by them were added. The
-- movie is consulted with id = 2.
-- --------------------------------------------------------------------
...
CALL calculate_rating_metrics(2);
