-- --------------------------------------------------------------------
-- TEST CASE: Successful list of movies.

-- DESCRIPTION:
-- The INSERT necessary to perform the query are added.
-- List of movies with the same genre as seen by the client with
-- id_cliend = 10 views in the last week.
-- --------------------------------------------------------------------
...
CALL recently_review(1,'Pelicula');
...
-- Pelicula
-- Titanic
-- "Una joven (Kate Winslet) de sociedad
-- abandona a su arrogante pretendiente (Billy Zane) por un artista
--  (Leonardo DiCaprio) humilde en el transatlántico que se hundió durante
--  su viaje inaugural."
-- 20th Century Fox
...
-- Pelicula
-- Wonder Woman
-- "Diana es una joven guerrera, hija de Hipólita, criada como princesa
-- guerrera de las amazonas en una isla llamada Themiscyra en donde es
-- protegida y entrenada para ser una luchadora invencible."
-- DC Films