-- -------------------------------------------------------
--  TEST CASE: Successful list of reviews made by
-- a customer with id = 4 within a range
-- ['2018-08-1','2018-08-4'] of dates.

-- DESCRIPTION: 2 customers and some reviews of them
-- are charged. There are three customer reviews
-- with id = 4 that are within the given date range;
-- two reviews fall out of range for a day of difference
-- -------------------------------------------------------
