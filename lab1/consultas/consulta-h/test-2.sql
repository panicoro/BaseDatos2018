-- -------------------------------------------------------
-- TEST CASE: Successful list of the best rated movies in
-- the last 6 months using the "average mark".

-- DESCRIPTION: Clients, content, movies and several
-- reviews were added on all the films; Unlike the previous
-- case, we changed the dates of some content reviews with
-- id = 5, to check that it takes the last 6 months.
-- We want to see it disappear from the ranking.
-- -------------------------------------------------------
...
VALUES
  ...
  (
    10, 4, 5, 'Amo esta también', '2017-08-1','5'
  ),
  (
