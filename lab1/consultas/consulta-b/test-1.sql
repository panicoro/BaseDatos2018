-- ------------------------------------------------------------
--  TEST CASE: Successful list with of movies with Leonardo
--  Dicaprio as protagonist.

-- DESCRIPTION:
-- Added actors to the database. Content was added where three
-- films starred by Leonardo Dicaprio, another that had him as a
-- secondary actor; A program in which Leonardo Dicaprio
-- participated was also added.
-- ---------------------------------------------------------------
